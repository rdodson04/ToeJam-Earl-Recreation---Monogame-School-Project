...
{
    public static Dictionary<string, Rectangle[]> GetAnimations(string NPCType)
    {
        return NPCType switch
        {
            "Funkotronians" => new Dictionary<string, Rectangle[]>
            {
                ["Sneak"] = new Rectangle[]
                {
            ...
            "Opera Singer" => new Dictionary<string, Rectangle[]>
            {
                ["Sneak"] = new Rectangle[]
                {
                    new Rectangle(21, 200, 30, 30),
            ...
            "Santa" => new Dictionary<string, Rectangle[]>
            {
                ["Sneak"] = new Rectangle[]
                {
                    new Rectangle(21, 200, 30, 30),
            ...
            "Wahini" => new Dictionary<string, Rectangle[]>
            {
                ["Sneak"] = new Rectangle[]
                {
                    new Rectangle(21, 200, 30, 30),
            ...
            "Wiseman" => new Dictionary<string, Rectangle[]>
            {
              ["Sneak"] = new Rectangle[]
                {
                    new Rectangle(21, 200, 30, 30),
            ...
            "Wizard" => new Dictionary<string, Rectangle[]>
            {
               ["Sneak"] = new Rectangle[]
                {
                    new Rectangle(21, 200, 30, 30),
            ...
            _ => throw new ArgumentException($"Unknown player type: {NPCType}")
        };
    }
}